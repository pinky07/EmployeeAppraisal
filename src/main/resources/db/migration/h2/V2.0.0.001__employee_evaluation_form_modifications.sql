...
-- Drop columns
ALTER TABLE EmployeeEvaluationForm DROP COLUMN employeeRelationshipId;
ALTER TABLE EmployeeEvaluationForm DROP COLUMN evaluationStatus;
...
INSERT INTO EmployeeEvaluationForm (id, appraisalXEvaluationFormTemplateId, employeeId, filledByEmployeeId, mentorId, createDate, submitDate)
VALUES

  -- Rubén Jiménez (id 2) - Self Evaluation
  (1, 1, 2, 2, 6, '2017-01-01 00:00:00-06', null),

  -- Rubén Jiménez (id 2) - Reference Evaluation
  (2, 2, 2, 3, 6, '2017-01-01 00:00:00-06', null),
  (3, 2, 2, 4, 6, '2017-01-01 00:00:00-06', null),
  (4, 2, 2, 5, 6, '2017-01-01 00:00:00-06', null),

  -- Rubén Jiménez (id 2) - Mentor Evaluation
  (5, 3, 2, 6, 6, '2017-01-01 00:00:00-06', null),

  -- Manuel Yépez (id 3) - Self Evaluation
  (6, 1, 3, 3, 6, '2017-01-01 00:00:00-06', null),

  -- Manuel Yépez (id 3) - Reference Evaluation
  (7, 2, 3, 2, 6, '2017-01-01 00:00:00-06', null),
  (8, 2, 3, 4, 6, '2017-01-01 00:00:00-06', null),
  (9, 2, 3, 5, 6, '2017-01-01 00:00:00-06', null),

  -- Manuel Yépez (id 3) - Mentor Evaluation
  (10, 3, 3, 6, 6, '2017-01-01 00:00:00-06', null);
